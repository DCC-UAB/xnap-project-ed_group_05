...
plt.ylabel('Loss')
plt.legend()
plt.savefig('/home/alumne/xnap-project-ed_group_05/experiments/wandb/p6_flores/loss_wb.png')
plt.show()
...
for i in range(len(output)):
    ...
    cur[:,:,0] = color_me[i][:,:,0]
    cur[:,:,1:] = output[i]
    imsave("/home/alumne/xnap-project-ed_group_05/experiments/wandb/p6_flores/img_"+str(i)+".png", lab2rgb(cur))
