...
plt.ylabel('Loss')
plt.legend()
plt.savefig('loss_plot_beta_flors.png')  # Guardar el gráfico en un archivo de imagen
plt.show()
# Plot loss history
...
for i in range(len(output)):
    ...
    cur[:,:,0] = color_me[i][:,:,0]
    cur[:,:,1:] = output[i]
    imsave("/home/alumne/xnap-project-ed_group_05-1/beta/flors/result_beta_flors/img_"+str(i)+".png", lab2rgb(cur))
